...
#define APPLE80211KEY_SCAN_PHY_MODE CFSTR("SCAN_PHY_MODE")
#define APPLE80211KEY_SCAN_TYPE CFSTR("SCAN_TYPE")
#define APPLE80211KEY_SCAN_MERGE CFSTR("SCAN_MERGE")
#define APPLE80211KEY_SCAN_NUM_SCANS CFSTR("SCAN_NUM_SCANS")
#define APPLE80211KEY_AUTH_UPPER CFSTR("AUTH_UPPER")
#define APPLE80211KEY_SSID_STR CFSTR("SSID_STR")
#define APPLE80211KEY_BSSID CFSTR("BSSID")
#define APPLE80211KEY_SCAN_SSID CFSTR("SSID")
